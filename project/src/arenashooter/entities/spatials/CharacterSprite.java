...
public class CharacterSprite extends Spatial {
	...
	public void rainConfetti() {
		...
		confett1.localPosition.set(0, -3.5);
		confett2.localPosition.set(0, -3.5);
		confett3.localPosition.set(0, -3.5);
		confett4.localPosition.set(0, -3.5);
		confett5.localPosition.set(0, -3.5);
		confett6.localPosition.set(0, -3.5);
		confett7.localPosition.set(0, -3.5);
