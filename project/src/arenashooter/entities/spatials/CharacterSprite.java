...
public class CharacterSprite extends Spatial {
	...
	private Texture brokenParry = Main.getRenderer().loadTexture("data/sprites/swooshes/Broken_Parry.png");
	private Texture parryShield = Main.getRenderer().loadTexture("data/sprites/swooshes/Parry_Oriented2.png");
	...
	private Texture charge1 = Main.getRenderer().loadTexture("data/sprites/swooshes/Tching1.png");
	private Texture charge2 = Main.getRenderer().loadTexture("data/sprites/swooshes/Tching2.png");
