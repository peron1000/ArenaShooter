...
public class Camera extends Spatial3 {
	 ...
	 * @param d delta time
	 */
	public void center( List<? extends Spatial> centerTargets, Vec3fi basePos, double d ) { //TODO: Improve bounds support
	...
	float getLowerX(Vec3fi basePos, float z) {
	...
	float getUpperY(Vec3fi basePos, float z) {
	...
	float getLowerY(Vec3fi basePos, float z) {
