...
public enum CollisionFlags {
	LANDSCAPE(CAT_LANDSCAPE, CAT_CHARACTER, CAT_ITEM, CAT_PROJ, CAT_RIGIDBODY), 
	...
	RIGIDBODY(CAT_RIGIDBODY, CAT_LANDSCAPE, CAT_CHARACTER, CAT_ITEM, CAT_PROJ, CAT_RIGIDBODY);
